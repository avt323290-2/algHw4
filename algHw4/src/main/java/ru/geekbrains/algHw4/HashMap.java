...
/**
 * Простая реализация хэш-таблицы HashMap с методами добавления, удаления и поиска элемента по ключу.
 *
 * @param <K> Тип ключа.
...
public class HashMap<K, V> implements Iterable<HashMap.Entity> {
    ...
    /**
     * Возвращает итератор для перебора элементов в HashMap.
     *
     * @return Итератор.
     */
    @Override
    ...
    /**
     * Итератор для перебора элементов в HashMap.
     */
    ...
    /**
     * Класс представляющий корзину хэш-таблицы.
     *
     * @param <K> Тип ключа.
     * @param <V> Тип значения.
     */
